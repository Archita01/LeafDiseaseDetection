...
txtHand = findall(handles.DetectDisease_GUI, '-property', 'FontUnits'); 
...
sprintf("The features are: ")
sprintf('Mean is: %g%%',(Mean))
sprintf('Standard Deviationn is: %g%%',(Standard_Deviation))
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
load('/MATLAB Drive/IP Project/Accuracy_Data.mat')
...
cp = classperf(groups(test,:), classes);
...
load('/MATLAB Drive/IP Project/Training_Data.mat')
